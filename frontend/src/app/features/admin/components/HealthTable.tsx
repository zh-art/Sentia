...
export default function HealthTable({ health }: HealthTableProps) {
  ...
  if (value.toLowerCase().includes("warning")) return "bg-yellow-100 text-yellow-800 border-yellow-300 dark:bg-yellow-900 dark:text-yellow-200 dark:border-yellow-700";
